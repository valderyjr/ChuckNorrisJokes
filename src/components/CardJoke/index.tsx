...
const CardJoke = ({ createdAt, text, id }: ICardJoke) => {
  ...
  return (
    <div
      id="box-joke"
      className="w-full max-w-xs h-auto min-h-[10rem] bg-gray-800 flex flex-col rounded-md overflow-hidden relative drop-shadow-[2px_2px_5px_#000000] break-words"
    >
      <span className="absolute right-2 top-2">
        <BsFillChatLeftQuoteFill fontSize={20} />
      </span>
      <p className="flex-1 font-bold pl-4 pr-8 py-4" id="text-joke">
        {text}
      </p>
